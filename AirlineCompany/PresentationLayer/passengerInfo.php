...
if(isset($_SESSION['selAdult']) && isset($_SESSION['selChild']) && isset($_SESSION['selInfant']))
{
	...
	{
		header("Location:http://localhost:8080/AirlineCompany/PresentationLayer/oldu.php");
	}
			    			...
			    			<div class="row" style="width: 1000px; " >
			    				<div class="col-xs-6 col-sm-6 col-md-4">
			    					...
			    					<label for="Name">Name</label>
			                         <input type="text" name=<?php echo $i."Name"?>  id="Name" minlength="2" maxlegth="30" onkeypress="return lettersOnly(event)" class="form-control input-sm" value=<?php if(isset($_SESSION["0Name"])) echo $_SESSION["0Name"] ?> >
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-4">
			    				   <div class="form-group">
			    				   <label for="Surname">Surname</label>
			    				   <input type="text" name=<?php echo $i."Surname"?> id="Surname" minleght="2" maxleght="30" class="form-control input-sm" onkeypress="return lettersOnly(event)" value=<?php if(isset($_SESSION[$i."Surname"])) echo $_SESSION[$i."Surname"] ?>>
			    				   </div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-4">
			 			...
			 			<div class="row" style="width: 1000px; " >
			    				<div class="col-xs-6 col-sm-6 col-md-4">
			    					...
			    					<label for="conName">Name</label>
			                         <input type="text" name="conName"  id="conName" minlength="2" maxlegth="30" onkeypress="return lettersOnly(event)" class="form-control input-sm" value=<?php if(isset($_SESSION["conName"])) echo $_SESSION["conName"] ?>>
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-4">
			    				   <div class="form-group">
			    				   <label for="conSurname">Surname</label>
			    				   <input type="text" name="conSurname" id="Surname" minleght="2" maxleght="30" class="form-control input-sm" onkeypress="return lettersOnly(event)" value=<?php if(isset($_SESSION["conSurname"])) echo $_SESSION["conSurname"] ?>>
			    				   </div>
			    				</div>
			    				</div>
			    		<div class="row" style="width: 1000px; " >
			    				<div class="col-xs-6 col-sm-6 col-md-4">
			    					...
			    					<label for="conPhone"><span class="glyphicon glyphicon-earphone"></span> Phone</label>
			                         <input type="text" name="conPhone"  id="conPhone" minlength="2" maxlegth="30" onkeypress="return lettersOnly(event)" class="form-control input-sm" value=<?php if(isset($_SESSION["conPhone"])) echo $_SESSION["conPhone"] ?> >
			    					</div>
			    				</div>
			    				<div class="col-xs-6 col-sm-6 col-md-4">
			    				   <div class="form-group">
			    				   <label for="conEmail"><span class="glyphicon glyphicon-envelope"></span> Email</label>
			    				   <input type="text" name="conEmail" id="conEmail" minleght="2" maxleght="30" class="form-control input-sm" onkeypress="return lettersOnly(event)" value=<?php if(isset($_SESSION["conEmail"])) echo $_SESSION["conEmail"] ?>>
			    				   </div>
			    				</div>
			    				</div>
			    		</div>
